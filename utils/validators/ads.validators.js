...
const { ADVISIBILITYTYPES } = require("../consts");
...
module.exports = {
    ...
    function(req, res, next) {
        ...
        Object.keys(ADVISIBILITYTYPES).forEach((type) => {
            if (ADVISIBILITYTYPES[type].name === req.body.visibility) {
                adVisibilityType = ADVISIBILITYTYPES[type];
            }
        });
        if (!adVisibilityType) {
